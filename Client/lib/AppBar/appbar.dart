...
import 'package:flutter/material.dart';
 ...
 final AppBar TopAppbar = AppBar(
   toolbarHeight: 70,
   title: Text(user.User_Local,style: TextStyle(fontSize: 20,fontWeight:FontWeight.w500),),
   actions: [
     Row(
       children: [
         ElevatedButton(onPressed: (){
           if(user.User_ID.compareTo("ADMIN")==0)
           print('qqqqq');
           else{
               showDialog(
         ...
         IconButton(
             ...
             onPressed: (){
               Navigator.push(navigatorContext, MaterialPageRoute(builder: (context) {
                 return Search_1();
               },));
