...
// 서울
['강남구', '강동구', '강북구', '강서구(서울)', '관악구', '광진구', '구로구', '금천구', '노원구', '도봉구', '동대문구', '동작구', '마포구', '서대문구', '서초구', '성동구', '성북구', '송파구', '양천구', '영등포구', '용산구', '은평구', '종로구', '중구(서울)', '중랑구'],
...
// 부산
['강서구(부산)', '금정구', '기장군', '남구(부산)', '동구(부산)', '동래구', '부산진구', '북구(부산)', '사상구', '사하구', '서구(부산)', '수영구', '연제구', '영도구', '중구(부산)', '해운대구'],
