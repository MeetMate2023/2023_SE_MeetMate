...
class _ViewtextState extends State<Viewtext> {
  ...
  void _showPopupMenu(BuildContext context,int index) async {
    final selectedValue = await showMenu(
      ...
      items: [
    PopupMenuItem(child: Text('프로필보기'),onTap: (){
    print('object');
    },),
    PopupMenuItem(child: Text('초대장 보내기'),onTap: () {
      print(dataList[widget.index]
      ['nickname']
          .toString());
      print(user.User_Nic);
      if (dataList[widget.index]
      ['nickname']
          .toString()
                            ...
                            Padding(
                              ...
                              child: Align(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(dataList[widget.index]['location'],style: TextStyle(color: Colors.grey,fontSize: 10),),
                                    Text(dataList[widget.index]['meetTime'],style: TextStyle(color: Colors.grey,fontSize: 10)),
